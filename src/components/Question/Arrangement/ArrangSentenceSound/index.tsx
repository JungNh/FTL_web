...
const ArrangSentenceSound: React.FC<Props> = ({
  lession,
  onNextLession,
  onSetResults,
  currentTestIndex,
  ...
  return (
    <div className="lession__listen--sentenceOrder pb-5">
      ...
      <Button.Shadow
        ...
        onClick={() => backCourse()}
      />
      <div className="main__question mb-5">
...
export default ArrangSentenceSound
