...
import QuizNewArrange from './QuizNewArrange'
...
const QuesType: FC<Props> = ({ question, quesIndex, setUserAns, userAns, isAnswerShow }) => (
  <div className="quiz__lession">
    ...
    {((question?.type === 'fill_word_multiple_answer' && question?.answers?.length === 1) ||
    ...
    {question?.type === 'fill_word_multiple_answer' && (question?.answers?.length || 0) > 1 && (
      <QuizFillWordMulti
        question={question}
        quesIndex={quesIndex}
        isAnswerShow={isAnswerShow}
