...
const PopupNotComplete: React.FC<Props> = ({ contest, isCheckBxh = false, setCheckShow }) => {
  ...
  return (
    <ModalCustomArena show={isCheckBxh} onHide={() => setCheckShow(false)}>
      <div className="popupnotcomplete__component">
        <div className="content__text" style={{ marginTop: 20 }}>
          <div>
        ...
        {dataRound?.bonus ? (
          ...
          <div className="content__buttons">
            <Button.Shadow content="Quay lại" color="blue" onClick={() => setCheckShow(false)} />
          </div>
        )}
      </div>
    </ModalCustomArena>
