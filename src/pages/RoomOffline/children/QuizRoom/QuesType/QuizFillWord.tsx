...
import { cleanSentence, htmlSpecialLetter } from '../../../../../utils/common'
import HandleMetas from '../../../../../components/Question/Arrangement/HandleMetas'
...
const QuizFillWord: React.FC<Props> = ({
  ...
  useEffect(() => {
    if (!_.isEmpty(question?.answers)) {
      ...
      if (!_.isEmpty(valueAns)) {
        // setCorrectAns(valueAns[0]?.value?.trim())
  ...
  return (
    <div className="lession__fillWord pb-5" style={{ paddingTop: 0 }}>
      ...
      {/* <HandleMetas metas={question?.metas} notAudio/> */}
      ...
      >
        {ReactHtmlParser(htmlSpecialLetter(question?.questionText || ''))}
      </div>
