...
import { numberTwoDigits, openWarning } from '../../../../../utils/common'
import { actionSendBulkAnswer } from '../../../../../store/lesson/actions'
import { actionUserContestFinish } from '../../../../../store/roomOffline/actions'
...
const SideBar: FC<Props> = ({
  ...
  const sendAnswer = async () => {
    ...
    const [resBulk, resFinish]: any = await Promise.all([
      dispatch(
    ...
    if (resBulk?.status === 200 && resFinish?.status === 200) {
  ...
  return (
    <div>
      {!isAnswerShow && duration !== null && duration > 0 && (
